...
const MODAL_RECORD = 'recordModal';
...
const openRecordModal = () => openMenu(MODAL_RECORD);
const closeRecordModal = () => closeMenu(MODAL_RECORD);
const recordModalOpen = state => state.scratchGui.menus[MODAL_RECORD];
